<x-app-layout>
    <div class="max-w-2x1 mx-auto bg-white p-6 rounded-lg shadow mt-8 text-center">
        <h2 class="text-x1 font-semibold mb-4 text-green-700">E-KYC Selesai</h2>
        ...
        <div class="flex flex-col items-center justify-center py-6">
            ...
            stroke="currenColor" stroke-width="2"> 
            <path stroke-linecap="round" stroke-linejoin="round"
                d="M9 1212 214-4m5 2a9 9 0 11-18 0a9 9 0 0118 0z" />
            </svg>
