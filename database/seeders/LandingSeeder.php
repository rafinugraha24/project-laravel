...
class LandingSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $settings = [
            ...
            ['hero_subtitle', 'LP3I hadir dengan fokus pendidikan vokasi yang relevan dengan dunia. Raih keterampilan praktis dan peluang karier lebih cepat bersama kami.', 'text'],
        ...
        $programs = [
            ...
            ['Informatika & Konputer', 'Program vokasi untuk dunia IT: pemrograman, jaringan, dan data', null, 2],
